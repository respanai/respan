...
class TestBuildPayload:
    ...
    def test_builds_payload_from_single_span(self):
        ...
        assert p["span_name"] == "dspy.predict"
    ...
    def test_stores_dspy_ids_in_metadata(self):
        from respan_exporter_dspy.exporter import RespanDSPyExporter
        ...
        assert "dspy_trace_id" in metadata
        assert "dspy_span_id" in metadata

    def test_sets_customer_identifier(self):
        from respan_exporter_dspy.exporter import RespanDSPyExporter

        exporter = RespanDSPyExporter(api_key="test", customer_identifier="user-42")
        span = self._make_span_dict()
        payloads = exporter.build_payload(trace_or_spans=[span])
...
class TestExport:
    ...
    def test_export_sends_payloads(self):
        ...
        exporter = RespanDSPyExporter(api_key="test-key")
        span = {
            "trace_id": "abcdef1234567890abcdef1234567890",
            "span_id": "1234567890abcdef",
            "parent_id": None,
        ...
        with patch("respan_exporter_dspy.exporter.requests.post") as mock_post:
    ...
    def test_export_skips_without_api_key(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            exporter = RespanDSPyExporter(api_key=None)
