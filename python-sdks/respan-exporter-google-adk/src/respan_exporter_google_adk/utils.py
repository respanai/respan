"""Utility functions for Respan Google ADK exporter."""
import json
import uuid
...
_ADK_SPAN_NAMES = {"invocation", "agent_run", "call_llm", "execute_tool"}
...
def is_adk_span(span: object) -> bool:
    ...
    if "google_adk" in scope_name or "google-adk" in scope_name:
        return True
